...
process.source = cms.Source("PoolSource",
    ...
    #fileNames = cms.untracked.vstring(#'root://cmsxrootd.fnal.gov//store/relval/CMSSW_12_0_1/RelValSingleMuPt10/GEN-SIM-DIGI-RAW/120X_mcRun3_2021_realistic_v5-v1/10000/adfe3835-ab15-4964-b1ab-bd97cbdb0972.root'
     #   'root://cmsxrootd.fnal.gov//store/relval/CMSSW_12_0_1/RelValSingleMuPt10/GEN-SIM-DIGI-RAW/120X_mcRun3_2021_realistic_v5-v1/10000/adfe3835-ab15-4964-b1ab-bd97cbdb0972.root'
    #),
...
#process.SKIMStreamEXODisappTrk.outputCommands.append('drop *')
...
#process.SKIMStreamEXODisappTrk.outputCommands.append('keep *_reducedHcalRecHits_*_*')
#process.SKIMStreamEXODisappTrk.outputCommands.append('keep *_reducedEcalRecHits*_*_*')
#process.SKIMStreamEXODisappTrk.outputCommands.append('keep *_dedxHitInfo_*_*')
#process.SKIMStreamEXODisappTrk.outputCommands.append('keep *_dedx*Harmonic2_*_*')
